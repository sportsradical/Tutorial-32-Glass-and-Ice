...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/cube.txt", "../Engine/data/seafloor.tga", "../Engine/data/bump03.tga");
	if(!result)
	{
	...
	result = m_WindowModel->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/square.txt", "../Engine/data/glass01.tga", "../Engine/data/bump03.tga");
	if(!result)
	{
